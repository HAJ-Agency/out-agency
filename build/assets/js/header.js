...
(function ($) {
  $(function () {
    ...
    $(document).on('click', function (e) {
      if (!$(e.target).closest('nav.header-navigation .wp-block-navigation__container, .wp-block-button.is-style-menu-btn ').length && $(e.target) !== $('nav.header-navigation .wp-block-navigation__container')) {
